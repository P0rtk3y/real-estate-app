...
export default function Home() {
  return (
    <div className="relative overflow-hidden">
      {/* Hero */}
      <div className="relative text-white py-20 px-4 overflow-hidden" style={{ background: 'linear-gradient(135deg, #C8281A 0%, #9B3012 30%, #5C1F0A 60%, #3D7A4A 100%)' }}>
        {/* Decorative shapes */}
        ...
        <div className="absolute top-1/2 -right-8 text-7xl opacity-10 select-none rotate-45">🌶️</div>

        <div className="relative max-w-4xl mx-auto text-center">
          {/* Lan character */}
          <div className="mb-6 relative inline-block">
            <div className="text-8xl" style={{ filter: 'drop-shadow(0 4px 20px rgba(200,40,26,0.4))' }}>🥖</div>
          ...
          {/* Character intro */}
          <div className="mb-3 inline-flex items-center gap-2 bg-white/15 backdrop-blur-sm border border-white/20 rounded-full px-4 py-1.5 text-sm font-semibold text-white/90">
            <span>Xin chào! I&apos;m</span>
            <span className="font-display text-base" style={{ color: '#FFD700' }}>Lan</span>
            <span>🥖 Your Vietnamese Property Scout</span>
          </div>

          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black mb-4 leading-tight">
            <span style={{ color: '#FFD700' }}>Ồ trời ơi!</span> I found<br />
            your dream home 🏡
          </h1>
          ...
          <div className="relative max-w-2xl mx-auto mb-8">
            <div className="bg-white/15 backdrop-blur-sm border border-white/20 rounded-3xl rounded-tl-none p-5 text-left">
              <p className="text-white/95 leading-relaxed text-base sm:text-lg">
                <span className="font-bold" style={{ color: '#FFD700' }}>Chào bạn!</span>{' '}
                (That&apos;s &quot;hello, friend!&quot; — Lan&apos;s first joke, free of charge 😄)
                I grew up in Hội An and trained in Sài Gòn
                ...
                has great food, what the weather is actually like, and what concerts are coming up!
                <span className="font-bold"> Được quá!</span> (That means &quot;excellent!&quot;)
              </p>
            </div>
      ...
      <div className="max-w-5xl mx-auto px-4 py-12">
        <div className="text-center mb-6">
          <h2 className="text-xl font-black text-gray-900 mb-1">🥖 Lan&apos;s Favorite Destinations</h2>
      ...
      {/* What Lan does */}
      <div className="border-t py-16" style={{ background: '#FFF9F0', borderColor: '#F5E6D3' }}>
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            <h2 className="text-2xl font-black text-gray-900">What Your Scout Does</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                ...
                lan: '"I compare every city to somewhere in Vietnam — it\'s my thing 😄"',
              },
              {
                emoji: '🌤️',
                title: 'Live Weather',
                desc: 'Current conditions and 5-day forecast from OpenWeatherMap.',
                lan: '"Rain or shine? You need to know before you move!"',
              },
              {
                emoji: '🎭',
              ...
              },
              {
                ...
                lan: '"No good noodle soup nearby? Lan is very concerned."',
              },
              {
                emoji: '🔔',
                title: 'Smart Alerts',
                desc: 'Weekly Tuesday alert for Miami, monthly Barcelona check-in — your schedule, your way.',
                lan: '"Lan will remind you! Like a very enthusiastic friend!"',
              },
              {
                emoji: '🎛️',
              ...
              },
              {
                ...
                lan: '"My grandma taught me: always look before you leap!"',
              },
              {
                emoji: '🤖',
                title: 'Scout Score',
              ...
              <div key={title} className="flex gap-4 p-5 rounded-2xl bg-white border border-amber-100 hover:border-amber-300 hover:shadow-md transition-all group">
                <span className="text-3xl flex-shrink-0">{emoji}</span>
                <div>
                  <h3 className="font-bold text-gray-900 mb-1 group-hover:text-red-700 transition-colors">{title}</h3>
                  <p className="text-sm text-gray-500 leading-relaxed mb-2">{desc}</p>
                  <p className="text-xs italic" style={{ color: '#C8281A' }}>{lan}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      {/* CTA */}
      <div className="py-14 px-4 text-center" style={{ background: 'linear-gradient(135deg, #C8281A 0%, #9B3012 50%, #3D7A4A 100%)' }}>
        <div className="max-w-2xl mx-auto">
          <div className="text-5xl mb-4">🥖</div>
          <h2 className="text-2xl font-black text-white mb-3">Ready to Scout? 🏡</h2>
          <p className="text-white/80 mb-6">Tell Lan which city and she&apos;ll find the culture, weather, and gorgeous homes!</p>
          <div className="flex justify-center">
            <CitySearch />
          </div>
        </div>
